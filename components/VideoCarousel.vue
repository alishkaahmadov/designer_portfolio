<template>
    <div class="carousel-wrapper">
        ...
        <div class="flex flex-col md:flex-row items-center justify-between h-full px-4 py-6 sm:px-6 sm:py-10 md:px-12 md:py-16 gap-8">
            <div class="flex flex-col justify-between w-full md:w-1/2 h-auto md:h-full min-h-[360px] sm:min-h-[220px] md:min-h-[0] gap-6">
                <h1 class="text-4xl md:text-5xl lg:text-5xl text-white montserrat-black leading-normal">
            ...
            <Swiper :modules="[Navigation]" :navigation="false" @swiper="onSwiper" @slideChange="onSlideChange" class="swiper w-full md:w-2/5 h-[220px] sm:h-[280px] md:h-full">
